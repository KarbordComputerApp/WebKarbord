...
! function(e) {
    ...
    ! function(e) {
        ...
        function z(t, a) {
            ...
            U(t, a.inLine, e(r).find("[data-selecteddatestring]").text().trim()), n.html(r)
        }

        function Q(e) {
            return void 0 == e.selectedDate ? "" : e.rangeSelector && void 0 != e.rangeSelectorStartDate && void 0 != e.rangeSelectorEndDate ? Ce(e.isGregorian ? De(e.rangeSelectorStartDate) : fe(e.rangeSelectorStartDate), e.textFormat, e.isGregorian, e.englishNumber) + " - " + Ce(e.isGregorian ? De(e.rangeSelectorEndDate) : fe(e.rangeSelectorEndDate), e.textFormat, e.isGregorian, e.englishNumber) : Ce(e.isGregorian ? De(e.selectedDate) : fe(e.selectedDate), e.textFormat, e.isGregorian, e.englishNumber)
        }

        function K(e) {
            return void 0 == e.selectedDate ? "" : e.rangeSelector && void 0 != e.rangeSelectorStartDate && void 0 != e.rangeSelectorEndDate ? Ce(De(e.rangeSelectorStartDate), e.dateFormat, e.isGregorian, !0) + " - " + Ce(De(e.rangeSelectorEndDate), e.dateFormat, e.isGregorian, !0) : Ce(De(e.selectedDate), e.dateFormat, e.isGregorian, !0)
        }
        ...
        function re(t, a, r) {
            var n = e.extend({}, t);
            return n.day = 1, n.month += a, r ? De(he(n)) : (n.month <= 0 && (n.month = 12, n.year--), n.month > 12 && (n.year++, n.month = 1), n)
        }

        function ne(e, t, a) {
            return a ? he(re(De(e), t, a)) : ge(re(fe(e), t, a))
        }
        ...
        function Ce(e, t, a, r) {
            return a && (r = !0), t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(/yyyy/gm, e.year)).replace(/yy/gm, e.year % 100)).replace(/MMMM/gm, ae(e.month, a))).replace(/MM/gm, Me(e.month))).replace(/M/gm, e.month)).replace(/dddd/gm, oe(e.day, a))).replace(/dd/gm, Me(e.day))).replace(/d/gm, e.day)).replace(/HH/gm, Me(e.hour))).replace(/H/gm, e.hour)).replace(/hh/gm, Me(function(e) {
                return e > 12 ? e - 12 : e
        ...
        function Te(e, t) {
            if (e) return t.isGregorian ? function(e) {
                ...
                if (c) {
                    ...
                    var p = e.match(/-\d{1,2}(?=-)/gim);
                    null != p && (n = p[0].replace(/\D+/, ""), e = e.replace(new RegExp("-" + n + "(?=-)", "img"), "-"));
                    var D = e.match(/-\d{4}(?=-)/gim);
                    null != D ? r = D[0].replace(/\D+/, "") : null != (D = e.match(/-\d{2,4}(?=-)/gim)) && (r = D[0].replace(/\D+/, ""))
                }
                var b = Number(r),
                    f = Number(a),
                    y = Number(n),
        ...
        function xe(t, a) {
            var r, n, o = Se(t.selectedDateToShow),
                ...
                l = {},
                m = 1;
            if (t.isGregorian ? (l = De(o), d = De(new Date), r = t.disableBeforeDate ? De(t.disableBeforeDate) : void 0, n = t.disableAfterDate ? De(t.disableAfterDate) : void 0) : (l = fe(o), d = fe(new Date), r = t.disableBeforeDate ? fe(t.disableBeforeDate) : void 0, n = t.disableAfterDate ? fe(t.disableAfterDate) : void 0), (t.fromDate || t.toDate) && t.groupId) {
                var u = e("[" + c + '="' + t.groupId + '"][data-toDate]'),
                    g = e("[" + c + '="' + t.groupId + '"][data-fromDate]');
                if (t.fromDate) {
                    var h = J(u).selectedDate;
                    n = h ? t.isGregorian ? De(h) : fe(h) : void 0
                } else if (t.toDate) {
                    var p = J(g).selectedDate;
                    r = p ? t.isGregorian ? De(p) : fe(p) : void 0
                }
            }
            m = 1;
        ...
        function Be(t) {
            ...
            var n, o, i = "",
                ...
                h = {},
                p = {};
            if (t.isGregorian ? (p = De(a), d = De(new Date), u = void 0 != l ? De(l) : void 0, g = void 0 != m ? De(m) : void 0, h = void 0 == t.selectedDate ? d : De(t.selectedDate), n = t.disableBeforeDate ? De(t.disableBeforeDate) : void 0, o = t.disableAfterDate ? De(t.disableAfterDate) : void 0) : (p = fe(a), d = fe(new Date), u = void 0 != l ? fe(l) : void 0, g = void 0 != m ? fe(m) : void 0, h = void 0 == t.selectedDate ? d : fe(t.selectedDate), n = t.disableBeforeDate ? fe(t.disableBeforeDate) : void 0, o = t.disableAfterDate ? fe(t.disableAfterDate) : void 0), (t.fromDate || t.toDate) && t.groupId) {
                var D = e("[" + c + '="' + t.groupId + '"][data-toDate]'),
                    f = e("[" + c + '="' + t.groupId + '"][data-fromDate]');
                if (t.fromDate && D.length > 0) {
                    var y = J(D).selectedDate;
                    o = y ? t.isGregorian ? De(y) : fe(y) : void 0
                } else if (t.toDate && f.length > 0) {
                    var v = J(f).selectedDate;
                    n = v ? t.isGregorian ? De(v) : fe(v) : void 0
                }
            }
            i = t.rangeSelector && void 0 != u && void 0 != g ? `${oe(u.dayOfWeek,t.isGregorian)}، ${u.day} ${ae(u.month-1,t.isGregorian)} ${u.year} - \n                ${oe(g.dayOfWeek,t.isGregorian)}، ${g.day} ${ae(g.month-1,t.isGregorian)} ${g.year}` : `${oe(h.dayOfWeek,t.isGregorian)}، ${h.day} ${ae(h.month-1,t.isGregorian)} ${h.year}`, s = `${t.isGregorian?"Today,":"امروز،"} ${d.day} ${ae(d.month-1,t.isGregorian)} ${d.year}`, t.englishNumber || (i = ee(i), s = ee(s)), void 0 != o && o.year <= p.year && o.month < p.month && (a = t.isGregorian ? new Date(o.year, o.month - 1, 1) : ue(o.year, o.month, o.day)), void 0 != n && n.year >= p.year && n.month > p.month && (a = t.isGregorian ? new Date(n.year, n.month - 1, 1) : ue(n.year, n.month, n.day));
            ...
            return S = S.replace(/{{monthTdStyle}}/gim, O), r = (r = (r = (r = (r = (r = r.replace(/{{selectedDateString}}/gim, i)).replace(/{{todayDateString}}/gim, s)).replace(/{{hour}}/gim, p.hour)).replace(/{{minute}}/gim, p.minute)).replace(/{{second}}/gim, p.second)).replace(/{{monthsTdHtml}}/gim, S)
        }
        ...
        function ke(t, r, n) {
            ...
            var m, u, g, h, p, D, b, C = 0,
                ...
                pe = "";
            if (t.isGregorian) {
                for (E = De(i), A = De(new Date), ne = t.disableBeforeDate ? De(t.disableBeforeDate) : void 0, se = t.disableAfterDate ? De(t.disableAfterDate) : void 0, m = new Date(E.year, E.month - 1, 1).getDay(), P = s ? le(De(s)) : 0, p = ve(E.year, E.month - 1), numberOfDaysInPreviousMonth = ve(E.year, E.month - 2), $ = le(De(we(i, !0))), j = le(De(Ne(i, !0))), i = Se(o), L = le(De(new Date(i.setFullYear(i.getFullYear() - 1)))), i = Se(o), R = le(De(new Date(i.setFullYear(i.getFullYear() + 1)))), i = Se(o), U = t.rangeSelector && W ? me(W) : 0, V = t.rangeSelector && _ ? me(_) : 0, C = 1; C <= 12; C++) Q["month" + C.toString() + "DateNumber"] = le(De(new Date(i.setMonth(C - 1)))), i = Se(o);
                for (C = 0; C < t.holiDays.length; C++) K.push(le(De(t.holiDays[C])));
                for (C = 0; C < t.disabledDates.length; C++) X.push(le(De(t.disabledDates[C])));
                for (C = 0; C < t.specialDates.length; C++) te.push(le(De(t.specialDates[C])))
            } else {
                for (E = fe(i), A = fe(new Date), ne = t.disableBeforeDate ? fe(t.disableBeforeDate) : void 0, se = t.disableAfterDate ? fe(t.disableAfterDate) : void 0, m = function(e, t, r, n, o, i) {
                    ...
                    }(E.year, E.month, 1, 0, 0, 0).dayOfWeek, P = s ? le(fe(s)) : 0, p = ye(E.year, E.month), numberOfDaysInPreviousMonth = ye(E.year - 1, E.month - 1), $ = le(fe(we(i, !1))), j = le(fe(Ne(i = Se(o), !1))), i = Se(o), L = ce(E.year - 1, E.month, E.day), R = ce(E.year + 1, E.month, E.day), i = Se(o), U = t.rangeSelector && W ? le(fe(W)) : 0, V = t.rangeSelector && _ ? le(fe(_)) : 0, C = 1; C <= 12; C++) Q["month" + C.toString() + "DateNumber"] = ce(E.year, C, ye(E.year, C)), i = Se(o);
            ...
            if ((t.fromDate || t.toDate) && t.groupId) {
                ...
                if (t.fromDate && be.length > 0) {
                    var Te = J(be).selectedDate;
                    se = Te ? t.isGregorian ? De(Te) : fe(Te) : void 0
                } else if (t.toDate && Ce.length > 0) {
                    var xe = J(Ce).selectedDate;
                    ne = xe ? t.isGregorian ? De(xe) : fe(xe) : void 0
                }
            }
            if (h = le(A), u = t.englishNumber ? E.year : ee(E.year), D = ne ? le(ne) : void 0, b = se ? le(se) : void 0, H = ae(E.month - 1, t.isGregorian) + " " + E.year.toString(), t.englishNumber || (H = ee(H)), g = ae(E.month - 1, t.isGregorian), t.yearOffset <= 0 && (de = "disabled", pe = "disabled", ge = "disabled"), 6 != m) {
                t.isGregorian && m--;
                var Be = re(E, -1, t.isGregorian);
                for (C = numberOfDaysInPreviousMonth - m; C <= numberOfDaysInPreviousMonth; C++) I = ce(Be.year, Be.month, C), q = t.englishNumber ? Me(C) : ee(Me(C)), O = e("<td data-nm />").attr("data-number", I).html(q), t.rangeSelector && (I == U || I == V ? O.addClass("selected-range-days-start-end") : U > 0 && V > 0 && I > U && I < V && O.addClass("selected-range-days")), t.isGregorian || 6 != T ? t.isGregorian && 0 == T && O.addClass("text-danger") : O.addClass("text-danger"), Y.append(O), N++, ++T >= 7 && (T = 0, F += Y[0].outerHTML, isTrAppended = !0, Y = e("<tr />"))
            }
            for (C = 1; C <= p; C++) {
        ...
        e(document).on("click", u + " [data-day]", function() {
            var t = e(this),
                ...
                n = _(t),
                o = void 0 == n.selectedDate ? void 0 : De(n.selectedDate),
                i = Se(n.selectedDateToShow);
            if (!a) {
                if (i = pe(r, i, n), n.rangeSelector) return void 0 != n.rangeSelectorStartDate && void 0 != n.rangeSelectorEndDate && (n.rangeSelectorStartDate = void 0, n.rangeSelectorEndDate = void 0, t.parents("table:last").find("td.selected-range-days-start-end,td.selected-range-days").removeClass("selected-range-days").removeClass("selected-range-days-start-end")), void 0 == n.rangeSelectorStartDate ? (t.addClass("selected-range-days-start-end"), n.rangeSelectorStartDate = Se(i), n.selectedDate = Se(i), n.selectedDateToShow = Se(i)) : void 0 != n.rangeSelectorStartDate && void 0 == n.rangeSelectorEndDate && (t.addClass("selected-range-days-start-end"), n.rangeSelectorEndDate = Se(i), X(n)), V(t, n), void(void 0 != n.rangeSelectorStartDate && void 0 != n.rangeSelectorEndDate && (n.inLine ? z(t, n) : de(e(m))));
                if (n.selectedDate = Se(i), n.selectedDateToShow = Se(i), void 0 != o && (n.selectedDate.setHours(o.hour), n.selectedDate.setMinutes(o.minute), n.selectedDate.setSeconds(o.second)), V(t, n), X(n), n.inLine)
                    if (n.inLine && (n.toDate || n.fromDate)) {
                        ...
                        n.fromDate && s.length > 0 ? z(s, _(s)) : n.toDate && d.length > 0 && z(d, _(d)), z(t, n)
                    } else z(t, n);
                else de(e(m))
            }
            ...
            a || (o = pe(r, o, n), n.selectedDateToShow = Se(o), V(t, n), z(t, n), void 0 != n.calendarViewOnChange && n.calendarViewOnChange(n.selectedDateToShow))
            ...
            o = (o = (o = (o = (o = (o = o.replace(/{{rtlCssClass}}/gim, a.isGregorian ? "" : "rtl")).replace(/{{yearsRangeText}}/gim, a.isGregorian ? n : ee(n))).replace(/{{previousText}}/gim, a.isGregorian ? "Previous" : "قبلی")).replace(/{{nextText}}/gim, a.isGregorian ? "Next" : "بعدی")).replace(/{{latestPreviousYear}}/gim, r.yearStart > r.yearEnd ? r.yearEnd : r.yearStart)).replace(/{{latestNextYear}}/gim, r.yearStart > r.yearEnd ? r.yearStart : r.yearEnd), U(t, a.inLine, o), s.html(i), s.removeClass("w-0"), a.inLine ? s.addClass("inline") : s.removeClass("inline")
            ...
            var t = e(this),
                ...
                s = p,
                d = o.html;
            s = (s = (s = (s = (s = (s = s.replace(/{{rtlCssClass}}/gim, a.isGregorian ? "" : "rtl")).replace(/{{yearsRangeText}}/gim, a.isGregorian ? i : ee(i))).replace(/{{previousText}}/gim, a.isGregorian ? "Previous" : "قبلی")).replace(/{{nextText}}/gim, a.isGregorian ? "Next" : "بعدی")).replace(/{{latestPreviousYear}}/gim, o.yearStart > o.yearEnd ? o.yearEnd : o.yearStart)).replace(/{{latestNextYear}}/gim, o.yearStart > o.yearEnd ? o.yearStart : o.yearEnd), U(t, a.inLine, s), e(u).find('[data-name="dateTimePickerYearsToSelectContainer"]').html(d)
        }), e(document).on("click", u + " [data-go-today]", function() {
            var t = e(this),
                a = _(t);
            a.selectedDateToShow = new Date, V(t, a), z(t, a)
        }), e("html").on("click", function(t) {
            h || (R(e(t.target)).length >= 1 || de(e(m)))
        });
        var Ge = {
            init: function(t) {
                return this.each(function() {
                    ...
                    r.disable && a.attr("disabled", ""), r.enableTimePicker && !r.textFormat ? r.textFormat = "yyyy/MM/dd   HH:mm:ss" : r.enableTimePicker || r.textFormat || (r.textFormat = "yyyy/MM/dd"), r.enableTimePicker && !r.dateFormat ? r.dateFormat = "yyyy/MM/dd   HH:mm:ss" : r.enableTimePicker || r.dateFormat || (r.dateFormat = "yyyy/MM/dd"), a.data(g, r), void 0 != r.selectedDate && (X(r), triggerChangeCalling = !1), r.inLine ? a.append(Be(r)) : a.popover({
                        ...
                        h = !0, a = e(this), (r = a.data(g)).disabled || (! function(t) {
                            ...
                            var t = Be(r);
                            U(a, r.inLine, e(t).find("[data-selecteddatestring]").text().trim()), W(a).find('[data-name="mds-datetimepicker-popoverbody"]').html(t), a.popover("update"), h = !1
                        }, 10))
            ...
            getDateRange: function() {
                ...
                return this.each(function() {
                    ...
                    var r = J(e("[" + c + '="' + a.groupId + '"][data-fromDate]')),
                        n = J(e("[" + c + '="' + a.groupId + '"][data-toDate]'));
            ...
            clearDate: function() {
                return this.each(function() {
                    var t = e(this),
                        a = J(t);
                    a.selectedDate = void 0, q(t, a), X(a)
                })
            },
