   ...
   // self.iconTypeArzName = ko.observable("");
    ...
    $("#Close_ModalAcc").click(function (e) {
        if (flag_Save == false) {
            ...
            flag_IsChange19 = (($("#ExtraFields01").val() == null ? '' : $("#ExtraFields01").val()) != sessionStorage.F01);
            flag_IsChange20 = (($("#ExtraFields02").val() == null ? '' : $("#ExtraFields02").val()) != sessionStorage.F02);
            flag_IsChange21 = (($("#ExtraFields03").val() == null ? '' : $("#ExtraFields03").val()) != sessionStorage.F03);
            flag_IsChange22 = (($("#ExtraFields04").val() == null ? '' : $("#ExtraFields04").val()) != sessionStorage.F04);
            flag_IsChange23 = (($("#ExtraFields05").val() == null ? '' : $("#ExtraFields05").val()) != sessionStorage.F05);
            flag_IsChange24 = (($("#ExtraFields06").val() == null ? '' : $("#ExtraFields06").val()) != sessionStorage.F06);
            flag_IsChange25 = (($("#ExtraFields07").val() == null ? '' : $("#ExtraFields07").val()) != sessionStorage.F07);
            flag_IsChange26 = (($("#ExtraFields08").val() == null ? '' : $("#ExtraFields08").val()) != sessionStorage.F08);
            flag_IsChange27 = (($("#ExtraFields09").val() == null ? '' : $("#ExtraFields09").val()) != sessionStorage.F09);
