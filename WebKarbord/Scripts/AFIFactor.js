var ViewModel = function () {
    ...
    self.selectKala = function (item) {
        ...
        getKalaPriceBList(kalapricecode, item.Code);
   ...
   // });
        ...
        if ($("#sumfactor").val() != '' && viewAction == true && firstUpdateShow == 0) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    //kalapricecode == '0' ? kalapricecode = 0 : kalapricecode = kalapricecode;
    ...
    function SetDataBarCode(kala, amountB) {
        ...
        getKalaPriceBList(kalapricecode, kala.Code);
    ...
    self.PageIndexFDocB = function (item) {
        return CountPage(self.filterFDocB(), self.pageSizeFDocB(), item);
    };
