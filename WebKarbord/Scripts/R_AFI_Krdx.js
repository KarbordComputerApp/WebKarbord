var ViewModel = function () {
    ...
    $('#SaveColumns').click(function () {
        SaveColumn(ace, sal, group, rprtId, "/ReportAFI/Krdx", columns, self.SettingColumnList());
   ...
   self.iconTypeKalaf20 = ko.observable("");*/
    ...
    self.PageIndexKrdx = function (item) {
        return CountPage(self.filterKrdxList(), self.pageSizeKrdx(), item);
    };
};
