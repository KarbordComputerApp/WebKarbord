    ...
    */
    ...
    if (sessionStorage.ModeCode == null || ShowNewTab != "ShowNewTab") {
        ...
        if (sessionStorage.ModeCode == sessionStorage.MODECODE_FDOC_S) {
            ...
            validation = CheckAccess('ACC_SFCT', 'Fct5');// AccessLinkAcc
        ...
        if (sessionStorage.ModeCode == sessionStorage.MODECODE_FDOC_SR) {
            ...
            validation = CheckAccess('ACC_SRFCT', 'Fct5');// AccessLinkAcc
            validation == true ? sessionStorage.Access_ACCLink = true : sessionStorage.Access_ACCLink = false
            validation == true ? localStorage.setItem("Access_ACCLink", "true") : localStorage.setItem("Access_ACCLink", "false")
        ...
        if (sessionStorage.ModeCode == sessionStorage.MODECODE_FDOC_P) {
            ...
            validation = CheckAccess('ACC_PFCT', 'Fct5');// AccessLinkAcc
            validation == true ? sessionStorage.Access_ACCLink = true : sessionStorage.Access_ACCLink = false
            validation == true ? localStorage.setItem("Access_ACCLink", "true") : localStorage.setItem("Access_ACCLink", "false")
        ...
        if (sessionStorage.ModeCode == sessionStorage.MODECODE_FDOC_PR) {
            ...
            validation = CheckAccess('ACC_PRFCT', 'Fct5');// AccessLinkAcc
            validation == true ? sessionStorage.Access_ACCLink = true : sessionStorage.Access_ACCLink = false
            validation == true ? localStorage.setItem("Access_ACCLink", "true") : localStorage.setItem("Access_ACCLink", "false")
    ...
    */
    ...
    $('#ChangeStatus').click(function () {
        ...
        if (invReg == "ثبت شده" && value == "باطل") {
            showNotification(translate('این اسناد به سند انبارداری لینک هستند و برای تغییر وضعیت، باید ابتدا اسناد انبارداری مرتبط حذف شوند'), 0);
        }
