var ViewModel = function () {
    ...
    self.pageSizeTrzFKala_S = ko.observable(pageSizeTrzFKala_S);
    ...
    self.currentPageTrzFKala_S = ko.computed(function () {
        ...
        localStorage.setItem('pageSizeTrzFKala_S', pageSizeTrzFKala_S);
    ...
    self.ShowPrintForms = function (item) {
        ...
        setReport(self.TrzFKala_SList(), data, printVariable);
    };
    ...
    $('#Print').click(function () {
        ...
        printName = null;
        sessionStorage.ModePrint = "ReportTrzFKala_S";
        GetPrintForms(sessionStorage.ModePrint);
    ...
    self.PageIndexTrzFKala_S = function (item) {
        return CountPage(self.filterTrzFKala_SList(), self.pageSizeTrzFKala_S(), item);
    };
};
