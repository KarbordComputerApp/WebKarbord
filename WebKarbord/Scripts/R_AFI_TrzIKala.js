var ViewModel = function () {
    ...
    $('#SaveColumns').click(function () {
        SaveColumn(ace, sal, group, rprtId, "/ReportAFI/TrzIKala", columns, self.SettingColumnList());
    });
  ...
  // $("#IDocR").hide();
    ...
    self.PageIndexTrzI = function (item) {
        return CountPage(self.filterTrzIList(), self.pageSizeTrzI(), item);
    };
