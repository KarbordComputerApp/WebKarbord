var ViewModel = function () {
    ...
    $('#SaveColumns').click(function () {
        SaveColumn(sessionStorage.ace, sessionStorage.sal, sessionStorage.group, rprtId, "/ReportAFI/TrzFCust_P", columns, self.SettingColumnList());
    });
    ...
    function getTrzFCust_P() {
        ...
        ajaxFunction(TrzFCust_PUri + ace + '/' + sal + '/' + group, 'POST', TrzFCust_PObject).done(function (response) {
    ...
    self.pageSizeTrzFCust_P = ko.observable(10);
    ...
    $('#refreshKGru').click(function () {
        Swal.fire({
            title: 'تایید به روز رسانی ',
            text: "لیست گروه کالا ها به روز رسانی شود ؟",
            type: 'info',
            showCancelButton: true,
            cancelButtonColor: '#3085d6',
            cancelButtonText: 'خیر',
