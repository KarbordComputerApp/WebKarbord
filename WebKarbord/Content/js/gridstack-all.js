        ...
        var e = {
                ...
                t.DDGridStack = class {
                    ...
                    on(e, t, i) {
                        return this._getDDElements(e).forEach((e => e.on(t, (e => {
                            i(e, o.DDManager.dragElement ? o.DDManager.dragElement.el : e.target, o.DDManager.dragElement ? o.DDManager.dragElement.helper : null)
                        })))), this
                    }
                    off(e, t) {
                    ...
                    _getDDElements(e, t = !0) {
                        let i = s.Utils.getElements(e);
                        if (!i.length) return [];
                        let o = i.map((e => e.ddElement || (t ? n.DDElement.init(e) : null)));
            ...
            270: function (e, t, i) {
                ...
                const n = i(62),
                    ...
                    d = i(939),
                    g = new a.DDGridStack;
                o(i(699), t), o(i(593), t), o(i(62), t), o(i(958), t);
                class u {
                    constructor(e, t = {}) {
                        var i, s;
                        ...
                        let g = Object.assign(Object.assign({}, r.Utils.cloneDeep(l.gridDefaults)), {
                    ...
                    addWidget(e, t) {
                        ...
                        } else if (0 === arguments.length || 1 === arguments.length && (void 0 !== (o = e).x || void 0 !== o.y || void 0 !== o.w || void 0 !== o.h || void 0 !== o.content))
                            if (s = t = e, null == s ? void 0 : s.el) i = s.el;
                            else {
                                let e = (null == t ? void 0 : t.content) || "",
                                    s = document.implementation.createHTMLDocument("");
                                s.body.innerHTML = `<div class="grid-stack-item ${this.opts.itemClass || ""}"><div class="grid-stack-item-content">${e}</div></div>`, i = s.body.children[0]
                            }
                        else i = e;
                        var o;
                        let n = this._readAttr(i);
                    ...
                    makeSubGrid(e, t, i, s = !0) {
                        ...
                        let a, h, d = l.el.querySelector(".grid-stack-item-content");
                        if (s) {
                            this._removeDD(l.el);
                            let e = document.implementation.createHTMLDocument("");
                            e.body.innerHTML = '<div class="grid-stack-item"></div>', a = e.body.children[0], a.appendChild(d), h = Object.assign(Object.assign({}, l), {
                                x: 0,
                                y: 0
                            }), r.Utils.removeInternalForSave(h), delete h.subGrid, l.content && (h.content = l.content, delete l.content), e.body.innerHTML = '<div class="grid-stack-item-content"></div>', d = e.body.children[0], l.el.appendChild(d), this._prepareDragDropByNode(l)
                        }
                        if (i) {
                        ...
                        let g = l.subGrid = u.addGrid(d, t);
                        return (null == i ? void 0 : i._moving) && (g._isTemp = !0), n && (g._autoColumn = !0), s && g.addWidget(a, h), i && (i._moving ? window.setTimeout((() => r.Utils.simulateMouseEvent(i._event, "mouseenter", g.el)), 0) : g.addWidget(l.el, l)), g
                    }
                    removeAsSubGrid(e) {
                        var t;
                    ...
                    load(e, t = !0) {
                        let i = u.Utils.sort([...e], -1, this._prevColumn || this.getColumn());
                        ...
                        return this.batchUpdate(), t && [...this.engine.nodes].forEach((e => {
                            ...
                            } else t && (e = "function" == typeof t ? t(this, e, !0).gridstackNode : (e.el ? this.addWidget(e.el, e) : this.addWidget(e)).gridstackNode)
                    ...
                    removeWidget(e, t = !0, i = !0) {
                        return u.getElements(e).forEach((e => {
                    ...
                    setStatic(e, t = !0, i = !0) {
                        return this.opts.staticGrid === e || (this.opts.staticGrid = e, this._setupRemoveDrop(), this._setupAcceptWidget(), this.engine.nodes.forEach((s => {
                    ...
                    static setupDragIn(e, t) {
                        void 0 !== (null == t ? void 0 : t.pause) && (d.DDManager.pauseDrag = t.pause), "string" == typeof e && (t = Object.assign(Object.assign({}, l.dragInDefaultOptions), t || {}), r.Utils.getElements(e).forEach((e => {
                            g.isDraggable(e) || g.dragIn(e, t)
                        })))
                    }
                    movable(e, t) {
                        return this.opts.staticGrid || u.getElements(e).forEach((e => {
                            let i = e.gridstackNode;
                    ...
                    enableMove(e, t = !0) {
                        return this.opts.staticGrid || (this.opts.disableDrag = !e, this.engine.nodes.forEach((i => {
                            this.movable(i.el, e), i.subGrid && t && i.subGrid.enableMove(e, t)
                        }))), this
                    }
                    enableResize(e, t = !0) {
                        return this.opts.staticGrid || (this.opts.disableResize = !e, this.engine.nodes.forEach((i => {
                            this.resizable(i.el, e), i.subGrid && t && i.subGrid.enableResize(e, t)
                        }))), this
                    }
                    _removeDD(e) {
                    ...
                    _setupAcceptWidget() {
                        if (this.opts.staticGrid || !this.opts.acceptWidgets && !this.opts.removable) return g.droppable(this.el, "destroy"), this;
                        let e, t, i = (i, s, o) => {
                            ...
                            if (n._temporaryRemoved) {
                                if (n.x = Math.max(0, Math.round(h / t)), n.y = Math.max(0, Math.round(a / e)), delete n.autoPosition, this.engine.nodeBoundFix(n), !this.engine.willItFit(n)) {
                                    if (n.autoPosition = !0, !this.engine.willItFit(n)) return void g.off(s, "drag");
                                    n._willFitPos && (r.Utils.copyPos(n, n._willFitPos), delete n._willFitPos)
                                }
                                this._onStartMoving(o, i, d, n, t, e)
                            } else this._dragOrResize(o, i, d, n, t, e)
                        };
                        return g.droppable(this.el, {
                            ...
                            return r.grid && r.grid !== this ? (o._gridstackNodeOrig || (o._gridstackNodeOrig = r), o.gridstackNode = r = Object.assign(Object.assign({}, r), {
                                ...
                                h: a,
                                grid: this
                            }), this.engine.cleanupNode(r).nodeBoundFix(r), r._initDD = r._isExternal = r._temporaryRemoved = !0) : (r.w = l, r.h = a, r._temporaryRemoved = !0), this._itemRemoving(r.el, !1), g.on(o, "drag", i), i(s, o, n), !1
                            ...
                            if (!n) return !1;
                            if (l && (this.engine.cleanupNode(n), n.grid = this), g.off(t, "drag"), i !== t ? (i.remove(), t.gridstackNode = a, l && (t = t.cloneNode(!0))) : (t.remove(), this._removeDD(t)), !l) return !1;
                            t.gridstackNode = n, n.el = t;
                            let h = null === (o = null === (s = n.subGrid) || void 0 === s ? void 0 : s.el) || void 0 === o ? void 0 : o.gridstack;
                            return r.Utils.copyPos(n, this._readAttr(this.placeholder)), r.Utils.removePositioningStyles(t), this._writeAttr(t, n), this.el.appendChild(t), h && (h.parentGridItem = n, h.opts.styleInHead || h._updateStyles(!0)), this._updateContainerHeight(), this.engine.addedNodes.push(n), this._triggerAddEvent(), this._triggerChangeEvent(), this.engine.endUpdate(), this._gsEventHandler.dropped && this._gsEventHandler.dropped(Object.assign(Object.assign({}, e), {
                                type: "dropped"
                            }), a && a.grid ? a : void 0, n), window.setTimeout((() => {
                                n.el && n.el.parentElement ? this._prepareDragDropByNode(n) : this.engine.removeNode(n), delete n.grid._isTemp
                            })), !1
                        })), this
                    }
                    _itemRemoving(e, t) {
                    ...
                    _setupRemoveDrop() {
                        if (!this.opts.staticGrid && "string" == typeof this.opts.removable) {
                            ...
                            if (!e) return this;
                            g.isDroppable(e) || g.droppable(e, this.opts.removableOptions).on(e, "dropover", ((e, t) => this._itemRemoving(t, !0))).on(e, "dropout", ((e, t) => this._itemRemoving(t, !1)))
                        }
                        return this
                    }
                    ...
                    _dragOrResize(e, t, i, s, o, n) {
                        let l, a = Object.assign({}, s._orig),
                            ...
                            p = Math.round(.1 * n),
                            c = Math.round(.1 * o);
                        if (h = Math.min(h, c), d = Math.min(d, c), g = Math.min(g, p), u = Math.min(u, p), "drag" === t.type) {
                            ...
                            let l = i.position.left + (i.position.left > s._lastUiPosition.left ? -d : h),
                                p = i.position.top + (i.position.top > s._lastUiPosition.top ? -u : g);
                            a.x = Math.round(l / o), a.y = Math.round(p / n);
                            ...
                            if (a.x < 0) return;
                            if (r.Utils.updateScrollResize(t, e, n), a.w = Math.round((i.size.width - h) / o), a.h = Math.round((i.size.height - g) / n), s.w === a.w && s.h === a.h) return;
                            if (s._lastTried && s._lastTried.w === a.w && s._lastTried.h === a.h) return;
                            let d = i.position.left + h,
                                u = i.position.top + g;
                            a.x = Math.round(d / o), a.y = Math.round(u / n), l = !0
                        }
                        ...
                        let m = {
                            ...
                            h: (i.size ? i.size.height : s.h * n) - g - u
                        };
                        if (this.engine.moveNodeCheck(s, Object.assign(Object.assign({}, a), {
                            ...
                            s._lastUiPosition = i.position, this.engine.cacheRects(o, n, g, d, u, h), delete s._skipDown, l && s.subGrid && s.subGrid.onParentResize(), this._extraDragRow = 0, this._updateContainerHeight();
                            let e = t.target;
                ...
                t.GridStack = u, u.Utils = r.Utils, u.Engine = n.GridStackEngine, u.GDRev = "7.1.2"
            },
            699: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
